 ...
 * momentivesoftware.assets.current.2026-09-01.xml — the filenames are swapped;
...
function momentive_wm_build_attachment_map(): array {
	$path = defined( 'MOMENTIVE_WM_LEGACY_WXR' )
		...
		: __DIR__ . '/exports/momentivesoftware.webinars.current.2026-09-01.xml';
...
function momentive_wm_build_video_map(): array {
	$path = defined( 'MOMENTIVE_WM_ASSETS_WXR' )
		...
		: __DIR__ . '/exports/momentivesoftware.assets.current.2026-09-01.xml';
