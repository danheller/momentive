<?php
/**
 * Title: Press Article Content
 * Slug: momentive/press-article-content
 * Description: Full layout for press articles: hero, byline, body, and sidebar.
...
<div class="wp-block-columns post-layout is-not-stacked-on-mobile">
	...
	<div class="wp-block-column post-content">
		...
		<!-- wp:paragraph {"placeholder":"Write your press release here\u2026"} -->
		<p></p>
		<!-- /wp:paragraph -->
